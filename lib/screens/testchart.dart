...
class SimpleTimeSeriesChart extends StatelessWidget {
  ...
  final bool animate;
  final datospasados datas;

  SimpleTimeSeriesChart( this.seriesList, {this.animate, this.datas});

  /// Creates a [TimeSeriesChart] with sample data and no transition.
  factory SimpleTimeSeriesChart.withSampleData(datospasados data) {
 ...
 static List<charts.Series<TimeSeriesSales, DateTime>> _createSampleData() {
    ...
    data.add(TimeSeriesSales(new DateTime(2017, 9, 19), 5));
